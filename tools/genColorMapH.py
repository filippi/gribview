...
# Usage
colormaps = list(plt.colormaps()) #['hot', 'viridis', 'plasma', 'plasma_r', 'coolwarm', 'grey', 'hot_r', 'spring', 'jet', 'turbo']
header_content = generate_colormap_header(colormaps, 512, scalemap=[0,  1], alpha=[1, 1], cbarPath=None, cbarTextRange=[])
with open("../src/colormap512.h", "w") as file:
